...
storage_path points to the immutable original bytes. ocr_source / ocr_confidence
record how text was extracted, enabling per-field confidence attribution.
"""
...
class Document(Base, TimestampMixin):
    ...
    # SHA-256 of the raw file bytes — used for content-based deduplication
